...
public class NetworkFactory {
  ...
  public static Pair<Path, Batfish> zooFromVI(String name, boolean fullMesh) {
  ...
  public static Pair<Path, Batfish> zooFromVSB(String name) {
  ...
  public static Pair<Path, Batfish> from(String configs, String name) throws IOException {
  ...
  public static Pair<Path, Batfish> example() {
  ...
  public static void simulate(Pair<Path, Batfish> pair) {
